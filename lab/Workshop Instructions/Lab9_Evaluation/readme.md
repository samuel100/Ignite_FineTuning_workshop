...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/architecture1.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/responsibleai2.png)	
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/2_safety-evaluation.jpg)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/4_evaluate-based-on-safety.png)	
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/5_performance-evaluation.jpg)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/6_evaluate-based-on-performance.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/7_create-hub.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/8_fill-hub.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/9_select-new-project.png)

- Enter Project name. It must be a unique value.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/10_create-project.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/11_select-endpoints.png) 

- Select endpoint that you created.

![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/12_select-endpoint-created.png)

- Select Consume from the navigation menu.

- Copy your REST endpoint and Primary key.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/13_copy-endpoint-key.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/14_select-new-connection.png)

- Select Custom keys from the navigation menu.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/15_select-custom-keys.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/16_add-connection.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/17_select-promptflow.png)

- Select Chat flow from the navigation menu.

![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/18_select-flow-type.png)

- Enter Folder name to use.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/19_enter-name.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/20_select-raw-file-mod.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/21_select-input-output.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/22_graph-example.png)

### Start Prompt flow

Select Start compute sessions to start Prompt flow.

![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/23_start-compute-session.png)

- Select Validate and parse input to renew parameters.

![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/24_validate-input.png)

- Select the Value of the connection to the custom connection you created. For example, connection.

 
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/25_select-connection.png)

### Chat with your custom Phi-3 / Phi-3.5 model
 
- Select Chat.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/26_select-chat.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/27_chat-with-promptflow.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/28_select-project-created.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/29_deploy-openai-model.png)

- Select Azure OpenAI model you'd like to use. For example, gpt-4o.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/31_select-openai-model.png)	
...
- Navigate to the Azure AI Studio project that you created.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/32_select-project-created.png)

In the Project that you created, select Evaluation from the left side tab.

- Select + New evaluation from the navigation menu. 

![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/33_select-evaluation.png)

- Select Prompt flow evaluation.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/34_promptflow-evaluation.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/35_evaluation-setting.png)	
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/36_evaluation-setting.png)
- Select Next.
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/37_evaluation-setting.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/38_evaluation-setting.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/39_evaluation-result-gpu.png)
...
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/40_evaluation-result-gpu.png

You can scroll down to view Detailed metrics result.
![](/lab/Workshop%20Instructions/Lab9_Evaluation/images/41_detailed-metrics-result.png)
